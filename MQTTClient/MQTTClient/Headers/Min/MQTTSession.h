 ...
 */
extern NSString * _Nullable const MQTTSessionErrorDomain;
 ...
 */
- (void)session:(MQTTSession* _Nonnull)session newMessage:(NSData* _Nonnull)data onTopic:(NSString* _Nonnull)topic;
 ...
 */
- (void)handleEvent:(MQTTSession * _Nonnull)session event:(MQTTSessionEvent)eventCode error:(NSError *_Nullable)error;
 ...
 */
- (void)connected:(MQTTSession * _Nonnull)session sessionPresent:(BOOL)sessionPresent;

/** gets called when a connection has been refused
 @param session the MQTTSession reporting the refusal
 @param error an optional additional error object with additional information
 */
- (void)connectionRefused:(MQTTSession * _Nonnull)session error:(NSError *_Nullable)error;
...
/** gets called when a connection error happened
 ...
 @param error an optional additional error object with additional information
 */
- (void)connectionError:(MQTTSession * _Nonnull)session error:(NSError *_Nullable)error;

/** gets called when an MQTT protocol error happened
 @param session the MQTTSession reporting the protocol error
 @param error an optional additional error object with additional information
 */
- (void)protocolError:(MQTTSession * _Nonnull)session error:(NSError *_Nullable)error;
 ...
 */
- (void)messageDelivered:(MQTTSession * _Nonnull)session msgID:(UInt16)msgID;
 ...
 */
- (void)subAckReceived:(MQTTSession * _Nonnull)session msgID:(UInt16)msgID grantedQoss:(NSArray<NSNumber *> * _Nonnull)qoss;
 ...
 */
- (void)unsubAckReceived:(MQTTSession * _Nonnull)session msgID:(UInt16)msgID;
 ...
 */
- (void)sending:(MQTTSession * _Nonnull)session type:(MQTTCommandType)type qos:(MQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData * _Nonnull)data;
...
/** gets called when a command is received from the MQTT broker
 ...
 @param data the payload data of the command if any, might be zero length
 */
- (void)received:(MQTTSession * _Nonnull)session type:(MQTTCommandType)type qos:(MQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData * _Nonnull)data;
 ...
 */
- (BOOL)ignoreReceived:(MQTTSession * _Nonnull)session type:(MQTTCommandType)type qos:(MQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData * _Nonnull)data;
 ...
 */
@property (strong) void (^ _Nonnull messageHandler)(NSData* _Nonnull message, NSString* _Nonnull topic);
 ...
 */
@property (strong, nonatomic) NSString * _Nullable streamSSLLevel;
...
/** topicAliasMaximum specifies the number of seconds after which a session should expire MQTT v5.0*/
@property (strong, nonatomic) NSDictionary <NSString *, NSString*> * _Nullable userProperty;
...
@property (strong, nonatomic) dispatch_queue_t _Nullable queue;
 ...
 */
@property (strong, nonatomic) id <MQTTTransport> _Null_unspecified transport;
...
- (void)disconnectWithReturnCode:(MQTTReturnCode)returnCode
           sessionExpiryInterval:(NSNumber * _Nullable)sessionExpiryInterval
                    ...
                    userProperty:(NSDictionary <NSString *, NSString *> * _Nullable)userProperty;
